...
#ifndef INC_ST7567S_H_
#define INC_ST7567S_H_

#define ST7567S_ADR	0x7F

#define LCD_HEIGHT 64
#define LCD_WIDTH 128
#define LCD_PAGE_HEIGHT 8
#define LCD_NUM_PAGES LCD_HEIGHT / LCD_PAGE_HEIGHT
#define LCD_CACHE_SIZE (LCD_NUM_PAGES * LCD_WIDTH)

#define PIXEL_OFF		0
#define PIXEL_ON		1
#define PIXEL_INVERT	0xFF
...
typedef struct
{
	...
	uint8_t Address;
	uint8_t LCD_Cache[LCD_NUM_PAGES][LCD_WIDTH];
	uint8_t LCD_Txt_X, LCD_Txt_Y;
...
void LCD_SetContrast(ST7567SStruct *st7567s, uint8_t contrast);
...
void LCD_SetPage(ST7567SStruct *st7567s, uint8_t page);
void LCD_SetColumn(ST7567SStruct *st7567s, uint8_t column);

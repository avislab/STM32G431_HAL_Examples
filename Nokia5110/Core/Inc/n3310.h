...
#define SET_DC(n3310)					HAL_GPIO_WritePin(n3310->DC_Port, n3310->DC_Pin, GPIO_PIN_SET)
#define RESET_DC(n3310)					HAL_GPIO_WritePin(n3310->DC_Port, n3310->DC_Pin, GPIO_PIN_RESET)

#define SET_CE(n3310)					HAL_GPIO_WritePin(n3310->CE_Port, n3310->CE_Pin, GPIO_PIN_SET)
#define RESET_CE(n3310)					HAL_GPIO_WritePin(n3310->CE_Port, n3310->CE_Pin, GPIO_PIN_RESET)

#define SET_RST(n3310)					HAL_GPIO_WritePin(n3310->RST_Port, n3310->RST_Pin, GPIO_PIN_SET)
#define RESET_RST(n3310)				HAL_GPIO_WritePin(n3310->RST_Port, n3310->RST_Pin, GPIO_PIN_RESET)

#define SET_SDIN(n3310)					HAL_GPIO_WritePin(n3310->SDIN_Port, n3310->SDIN_Pin, GPIO_PIN_SET)
#define RESET_SDIN(n3310)				HAL_GPIO_WritePin(n3310->SDIN_Port, n3310->SDIN_Pin, GPIO_PIN_RESET)

#define SET_SCLK(n3310)					HAL_GPIO_WritePin(n3310->SCLK_Port, n3310->SCLK_Pin, GPIO_PIN_SET)
#define RESET_SCLK(n3310)				HAL_GPIO_WritePin(n3310->SCLK_Port, n3310->SCLK_Pin, GPIO_PIN_RESET)
...
static const uint8_t FontLookup [][5] =
{
   ...
   //{0x0, 0x12, 0x3F, 0x2D, 0x12}, // | 0x7C 124 | - у якості символа Bluetooth
   { 0x00, 0x41, 0x36, 0x08, 0x00 },   // } 0x7D 125
   { 0x08, 0x04, 0x08, 0x10, 0x08 },   // ~ 0x7E 126
   { 0x06, 0x09, 0x09, 0x06, 0x00 },   // "градуси" 0x7F 127


   { 0x7F, 0x01, 0x01, 0x01, 0x01 },   // Ґ 0xA5 165
   { 0x3E, 0x49, 0x49, 0x41, 0x22 },   // Є 0xAA 170
   { 0x00, 0x45, 0x7C, 0x45, 0x00 },   // Ї 0xAF 175
   { 0x00, 0x41, 0x7F, 0x41, 0x00 },   // І 0xB2 178

   { 0x00, 0x44, 0x7D, 0x40, 0x00 },   // і 0xB3 179
   { 0x7C, 0x04, 0x04, 0x06, 0x00 },   // ґ 0xB4 180
   { 0x38, 0x54, 0x54, 0x44, 0x28 },   // є 0xBA 186
   { 0x00, 0x45, 0x7C, 0x41, 0x00 },   // ї 0xBF 191
...
// Large Numbers
static const uint8_t BigNumbers [][20] =
{
...
// Large Numbers
static const uint8_t LargeNumbers [][80] =
{
